...
{
    public class ChangeProductWeightCommandHandler : IRequestHandler<ChangeProductWeightCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(ChangeProductWeightCommand command, CancellationToken cancellationToken)
        {
